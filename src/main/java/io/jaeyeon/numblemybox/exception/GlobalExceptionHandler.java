...
public class GlobalExceptionHandler {
  ...
  protected ResponseEntity<ErrorResponse> handleBindException(BindException e) {
    ...
    ErrorResponse errorResponse =
        ErrorResponse.of(HttpStatus.BAD_REQUEST.toString(), e.getBindingResult());
  ...
  protected ResponseEntity<ErrorResponse> handleHttpRequestMethodNotSupportedException(
    ...
    ErrorResponse errorResponse =
        ErrorResponse.of(HttpStatus.METHOD_NOT_ALLOWED.toString(), e.getMessage());
    return ResponseEntity.status(HttpStatus.METHOD_NOT_ALLOWED).body(errorResponse);
  }

  /** 비즈니스 로직 실행 중 오류 발생 */
  @ExceptionHandler(value = {NumbleMyBoxException.class})
  protected ResponseEntity<ErrorResponse> handleConflict(NumbleMyBoxException e) {
